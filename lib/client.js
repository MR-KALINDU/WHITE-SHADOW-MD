...
try {
    ...
    console.log("🌍 CONNECTING TO WHITE-SHADOW DATABASE")
} catch {
 ...
 Void.ev.on('group-participants.update', async(anu) => {
        ...
        Void.ev.on('connection.update', async(update) => {
                ...
                if (connection === 'open') {
                    ...
                    for (let i of owner) {
                Void.sendMessage(i + "@s.whatsapp.net", {image: {url: `https://telegra.ph/file/e9c7c757ed8011e8355f8.jpg`}, caption: `*SUCCESFULLY CONNECTED TO WHITE-SHADOW-MD ...✅*\n\nℹ️ *YOU CAN JOIN THE SUPPORT GROUP AND SOLVE THE PROBLEMS OF THE BOT* \n\n🪀 _*SUPPORT GROUP:*_\nhttps://chat.whatsapp.com/LkP8QZqdhXUKxmc0hUPip5\n\n🖇️ _*BOT GITHUB LINK :*_\nhttps://github.com/MR-KALINDU/WHITE-SHADOW-MD` })

                    }
			
                return Void.sendMessage("94758179948@s.whatsapp.net", { text: `_💠 HEY WHITE-SHADOW BOT OWNER_\n\n_🎲 I SUCCESFULLY CREATED YOUR BOT_\n_🎲 TOTAL PLUGINS : ${events.commands.length}_\n_🎲 VERSION:- 0.0.1_\n` })
                }
